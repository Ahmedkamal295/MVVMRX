...
class Helper: NSObject {
    ...
    class func user_country()->String {
        
        let user_country = "country"
        return user_country
    }
    
    class func user_imageCountry()->String {
        
        let user_imageCountry = "imgCountry"
        return user_imageCountry
    }
    class func user_idImgCountry()->String {
        
        let user_idImgCountry = "idImgCountry"
        return user_idImgCountry
    }
    
    //MARK:- Save user
    class func SaveidImgCountry(idImgCountry : String?){
        
        let def = UserDefaults.standard
        def.setValue(idImgCountry, forKey: user_idImgCountry())
        def.synchronize()
    }
    class func Saveuser_imgCountry(user_imageCountry : String?){
        
        let def = UserDefaults.standard
        def.setValue(user_imageCountry, forKey: self.user_imageCountry())
        def.synchronize()
    }
    class func Saveuser_country(user_country : String?){
        
        let def = UserDefaults.standard
        def.setValue(user_country, forKey: self.user_country())
        def.synchronize()
    }
    ...
    class func Saveuser_birth(birth : String?){
        
        let def = UserDefaults.standard
        def.setValue(birth, forKey: user_birth())
        def.synchronize()
    }
    //MARK:- get user
    ...
    class func getidImgCountry()->String? {
        
        let def = UserDefaults.standard
        return def.object(forKey: user_idImgCountry()) as? String
    }
    ...
    class func getauser_country()->String? {
        
        let def = UserDefaults.standard
        return def.object(forKey: user_country()) as? String
    }
    class func getauser_imgcountry()->String? {
        
        let def = UserDefaults.standard
        return def.object(forKey: user_imageCountry()) as? String
    }
    ...
    class func getauser_birth()->String? {
        
        let def = UserDefaults.standard
        return def.object(forKey: user_birth()) as? String
    ...
    //MARK:- restart App to first viewController
    class func restartApp<viewController: UIViewController>(id: viewController.Type){
        
        guard let window =  UIApplication.shared.windows.first else { return }
        let sb = UIStoryboard(name: "Login", bundle: nil)
        var vc : UIViewController
        vc = sb.instantiateViewController(withIdentifier: String(describing: id.self))
